        ...
        if (_import_directory_count > 0) {
            ...
            for (int i = 0; i < _import_directory_count; i++) {
                ...
                while (true) {
                    ...
                    // PHÉP TOÁN BITWISE ĐỂ PHÂN RÃ BẢNG THUNK ILT
                    ...
                    // THUẬT TOÁN CÀO CHUỖI THÍCH ỨNG ADAPTIVE BUFFERS
...
private:
    ...
    // CẶP HÀM TOÁN HỌC DỊCH CHUYỂN ĐỊA CHỈ RVA TO RAW
    ...
    // HÀM ĐIỀU PHỐI ỦY QUYỀN PARSEFILE
